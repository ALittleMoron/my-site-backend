...
def get_config_variable_as_list(config: 'Config', key: str) -> Optional[list[str]]:
    """Parse `alembic` segment of alembic.ini file for given key.

    Args:
        config (Config): object of alembic config.
        key (str): name of variable in alembic.ini config.

    Returns:
        list[str] | None: parsed segment as list of None.
    """
...
def is_object_included(_, name: str, type_: str, *__: Any, **___: Any) -> bool:
    ...
    Returns:
        bool: flag of passing in migrations.
    """
